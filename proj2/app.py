...
app.jinja_env.globals["is_valid_article_url"] = is_valid_article_url
...
def speeches_extract() -> Response:
    try:
        ...
        flash(str(exc), "danger")
    return redirect(url_for("index") + "#speeches")


@app.post("/speeches/save-extracted")
...
def incidents_extract() -> Response:
    try:
        ...
        flash(str(exc), "danger")
    return redirect(url_for("index") + "#incidents")


@app.post("/incidents/save-extracted")
...
def data_search() -> Response:
    ...
    if not query:
        ...
        return redirect(url_for("index") + "#data-search")
...
@app.post("/speeches/<int:speech_id>/update")
...
@app.post("/speeches/<int:speech_id>/delete")
...
@app.post("/incidents/<int:incident_id>/update")
...
@app.post("/company-accidents/generate")
...
@app.post("/company-accidents/<int:accident_id>/update")
...
@app.post("/company-accidents/<int:accident_id>/delete")
